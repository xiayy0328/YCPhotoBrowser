//
//  YCPhotoSmoothZoomAnimator.swift
//  YCPhotoBrowserDemo
//
...
/// 更丝滑的Zoom动画
open class YCPhotoSmoothZoomAnimator: NSObject, YCPhotoAnimatedTransitioning {
    ...
    /// 替补的动画方案
    open lazy var substituteAnimator: YCPhotoAnimatedTransitioning = YCPhotoFadeAnimator()
    ...
    private func transitionViewAndFrames(with browser: YCPhotoBrowser) -> (UIView, CGRect, CGRect)? {
