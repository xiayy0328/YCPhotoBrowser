...
open class YCPhotoImageCell: UIView, UIScrollViewDelegate, UIGestureRecognizerDelegate, YCPhotoCell, YCPhotoZoomCell {
    ...
    open lazy var imageView: YCPhotoImageView = {
        let view = YCPhotoImageView()
    ...
    /// 生成实例
    public static func generate(with browser: YCPhotoBrowser) -> Self {
    ...
    /// 长按事件
    public typealias LongPressAction = (YCPhotoImageCell, UILongPressGestureRecognizer) -> Void
    ...
    @objc open func onPan(_ pan: UIPanGestureRecognizer) {
        ...
        case .changed:
            ...
            browser?.setStatusBar(hidden: result.scale > 0.99)
        ...
        case .ended, .cancelled:
            ...
            if isDown {
                ...
                browser?.setStatusBar(hidden: true)
